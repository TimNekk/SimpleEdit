Реализованно все кроме ДОП. 15 (авто. форматирование)

Лучше запускать через райдер или exe файл (может вылететь эксепшон, который вижла не ловит)

Горячие клавишы можно найти в верхнем меню (где выпадающие вкладки)
...
(обычно он находится в C:\Windows\Microsoft.NET\Framework\версия\csc.exe)
